	...
	<table>
		<tr>
			...
			<td align="left" bordercolor="c41200">
				...
				<P>In earlear example we have already use of ClassPathXmlApplicationContext and AnnotationConfigApplicationContext now we will see what BeanFactory really means.
				</P>
		</tr>
	</table>
